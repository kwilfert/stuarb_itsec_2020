...
\end{minipage}
\hfill
\verb|SMB_Parameters| speichert in sich mehrere Parameter, die jeweils maximal vier Bytes an Speicher einnehmen können. Die Variable WordCount ist hier auch zu finden. Sie gibt die Länge der \verb|SMB_Parameters| Daten in WORDs an. Abhängig von Typ des Requests unterscheided sich auch deren Länge. Bei LM und NTLM beträgt diese stets 13 während die von NTLMv2 12 beträgt.
