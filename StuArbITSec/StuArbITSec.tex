...
\chapter{Disclaimer}
Da Microsofts Implementierung des SMB Protokolls deren geistiges Eigentum ist, muss sich an die Nutzungsbedingungen gehalten werden. Deshalb muss eingeräumt werden, dass es sich bei den in der Studienarbeit vorkommenden Codefragmenten lediglich um Pseudocode aus Online-Quellen und nicht um tatsächlichen dekompilierten Code handelt\cite{MS:LicTerm}.\\
